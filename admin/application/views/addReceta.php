                                        ...
                                        <div class="tab-pane active" id="ingredientes" role="tabpanel">                                    
                                            <div class="form-group">
                                                <textarea class="form-control"
                                                        ...
                                                        id="txt_ingrediente"><b>Ingredientes:</b></textarea>               
                                            </div>                    
                                        </div>
                                        <div class="tab-pane" id="preparacion" role="tabpanel">
                                            <div class="form-group">
                                                <textarea class="form-control"
                                                        ...
                                                        id="txt_preparacion"><b>Preparaci&oacuten:</b> </textarea>               
                                            </div>     
...
$(document).ready(function() {
    ...
    $("#btn_guardar").click(function(){
        ...
        var text_ingrediente=tinyMCE.get('txt_ingrediente').getContent();
        ...
        if(camposRellenados){ 
            ...
            $.ajax({
                ...
                processData: false,
                dataType: "json",
                url:" <?php  echo site_url('AddRecetaController/guardar_receta'); ?>",
                data: formData,
                beforeSend:function(){
                    $(".msg_danger").html();
                    $(".msg_success").html();
